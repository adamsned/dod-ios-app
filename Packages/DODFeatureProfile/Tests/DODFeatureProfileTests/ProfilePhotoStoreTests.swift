...
struct ProfilePhotoStoreTests {
    ...
    @Test func existsReturnsFalseForMissingFile() async throws {
        ...
        // Filename the store never wrote — the stale-reference shape
        // from CL-143 (Keychain row persists, Documents wiped).
    ...
    @Test func inMemoryStoreExistsReturnsTrueForRealFile() async throws {
        let store = InMemoryProfilePhotoStore()
    ...
    @Test func inMemoryStoreExistsReturnsFalseForMissingFile() async throws {
        let store = InMemoryProfilePhotoStore()
    ...
    @Test func inMemoryStoreExistsReturnsFalseForEmptyString() async throws {
        let store = InMemoryProfilePhotoStore()
    ...
    @Test func inMemoryStoreExistsOriginalReturnsTrueForRealFile() async throws {
        let store = InMemoryProfilePhotoStore()
        let image = Self.solidColorImage(side: 128, color: .yellow)
    ...
    @Test func inMemoryStoreExistsOriginalReturnsFalseForMissingFile() async throws {
        let store = InMemoryProfilePhotoStore()
    ...
    @Test func inMemoryStoreExistsOriginalReturnsFalseForEmptyString() async throws {
        let store = InMemoryProfilePhotoStore()
